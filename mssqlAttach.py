...
def mssqlAttach(arglist):
    parser = argparse.ArgumentParser(description='Attach database file to an MS SQL Server instance.')
    ...
    api.attach(args.filename, args.dbname)
